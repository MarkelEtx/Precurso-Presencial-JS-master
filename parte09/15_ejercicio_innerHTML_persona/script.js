...
//let nombre = "Crane Harris";

console.log(Object.values(personas));

for (let i = 0; i < Object.values(personas).length; i++) {
  if (nombre == Object.values(personas)[i].name) {
    document.querySelector("img").src = personas[nombre].picture;
    document.querySelector("h1").innerHTML = nombre;
    document.getElementById("parrafo1").innerHTML = personas[nombre].age;
    document.getElementById("parrafo2").innerHTML = personas[nombre].email;
    document.getElementById("parrafo3").innerHTML = personas[nombre].address;
    document.getElementsByClassName("ficha")[0].style.backgroundColor = personas[nombre].eyeColor;
    break;
  } else {
    document.querySelector("h1").innerHTML = "No Existe";
  }
